                        ...
                        <form>
                            ...
                            <asp:Panel ID="panelDatos" runat="server">
                                ...
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <asp:Label ID="Label1" class="col-sm-2 col-form-label font-weight-bold" runat="server" Text="Nombre:"></asp:Label>
                                            <asp:Label ID="lblNombre" class="col-sm-10 col-form-label" runat="server" Text=""></asp:Label>
                                        </div>
                                        <div class="row">
                                            <asp:Label ID="Label2" class="col-sm-2 col-form-label font-weight-bold" runat="server" Text="Email:"></asp:Label>
                                            <asp:Label ID="lblEmail" class="col-sm-10 col-form-label" runat="server" Text=""></asp:Label>
                                        </div>
                                        <div class="row">
                                            <asp:Label ID="Label3" class="col-sm-2 col-form-label font-weight-bold" runat="server" Text="Pais:"></asp:Label>
                                            <asp:Label ID="lblPais" class="col-sm-10 col-form-label" runat="server" Text=""></asp:Label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-12 table-responsive">
                                        <asp:GridView ID="gvReservas" runat="server" class="table table-sm table-hover table-bordered" AutoGenerateColumns="False">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="FechaInicio" HeaderText="Fec. Ingreso" DataFormatString="{0:dd/MM/yyyy}">
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="FechaSalida" HeaderText="Fec. Salida" DataFormatString="{0:dd/MM/yyyy}">
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:BoundField>
                                ...
                                <div class="row mb-2 pull-right" style="padding-right:15px !important;">
                                    <label class="col-7 col-form-label text-right">Total gastado:</label>
                                    <asp:TextBox ID="txtTotal" class="col-5 form-control text-right" runat="server"></asp:TextBox>
                                </div>
                            </asp:Panel>
                            <div class="row">
                                <div class="col-12">
