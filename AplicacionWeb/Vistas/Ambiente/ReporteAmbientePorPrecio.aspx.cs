...
{
    public partial class ReporteAmbientePorPrecio : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Decimal precMin = Convert.ToDecimal(txtPrecMin.Text.Trim());
                Decimal precMax = Convert.ToDecimal(txtPrecMax.Text.Trim());

                gvAmbientes.DataSource = serviceAmbiente.obtenerAmbienteDisponiblePorRangoDePrecios(fecIng, fecSal, precMin, precMax, idUbig);
