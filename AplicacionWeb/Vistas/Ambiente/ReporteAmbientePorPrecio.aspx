<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteAmbientePorPrecio.aspx.cs" Inherits="AplicacionWeb.Vistas.Ambiente.ReporteAmbientePorPrecio" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table class="nav-justified" style="margin-top: 20px">
        <tr>
            <td colspan="4">
                <br />
                <span style="font-weight: bold; font-size: large">Ambientes disponibles por rango de precio</span><br />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 232px; height: 20px;">Precio mínimo:</td>
            <td class="modal-sm" style="width: 232px; height: 20px;">Precio máximo:</td>
            <td style="width: 232px; height: 20px;"></td>
            <td style="height: 20px"></td>
        </tr>
        <tr>
            <td style="width: 232px">
                <asp:TextBox ID="txtPrecMin" runat="server" Width="100px"></asp:TextBox>
            </td>
            <td class="modal-sm" style="width: 232px">
                <asp:TextBox ID="txtPrecMax" runat="server" Width="100px"></asp:TextBox>
            </td>
            <td style="width: 232px">&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
