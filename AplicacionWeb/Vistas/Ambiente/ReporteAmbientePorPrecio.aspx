    ...
    <form runat="server">
        <div class="row">
            <div class="col-lg-12 mx-auto">
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">Ambientes disponibles por rango de precios</div>
                        <hr>
                        <form>
                            <div class="row">
                                <div class="col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtPrecMin" class="form-control" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="input-3">Aforo máximo</label>
                                        <asp:TextBox ID="txtPrecMax" class="form-control" runat="server"></asp:TextBox>
                                    </div>
                                </div>
