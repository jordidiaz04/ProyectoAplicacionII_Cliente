...
{
    public partial class ReporteAmbientePorFecha : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                gvAmbientes.DataSource = serviceAmbiente.obtenerAmbienteDisponiblePorFecha(fecIng, fecSal, idUbig);
